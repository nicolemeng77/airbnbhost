...
#error variance is not constant, errors are correlated remedial measures: Transformation, Cochrane-Orcutt Procedure
...
#There is skewness, many points off the normal line. Thus the residuals are not normally distributed. Also the p-value of test is small so that we reject the null hypothesis (residuals are normally distributed)
