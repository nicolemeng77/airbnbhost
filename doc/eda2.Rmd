...
data <- data %>% 
  mutate_if(is.logical, as.numeric) %>% # convert True False to 1,0
  mutate_at(c('transit_level', 'rule_pets', 'have_pet', 'have_shampoo', 'have_gym', 'have_washer', 
...
#pairwise test for multiple groups
...
#property_type
pairwise.wilcox.test(data$price, data$property_type)
#there is significant differences in prices among different property types
