...
#summary(fit_linear)
#Multiple R-squared:  0.5321, Adjusted R-squared:  0.5317
...
aaa <- aa[-1,]
colnames(aaa) <- c('row', 'value')
ggplot(aaa, aes(value, reorder(row, value))) +
